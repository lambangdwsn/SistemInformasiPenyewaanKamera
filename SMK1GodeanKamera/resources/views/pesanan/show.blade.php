...
<form action="{{url(route('pesanan.update',['id' => $pesanan->id]))}}" method="post">
@csrf
    ...
    <tbody>
      <tr>
        ...
        <td data-label="Jumlah">
            <input type="number" class="form-control @error('jumlah') is-invalid @enderror" name="jumlah" value="{{old('jumlah',$pesanan->jumlah)}}" required>
            @error('jumlah')

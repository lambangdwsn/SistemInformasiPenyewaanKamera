...
@section('title','Inventaris Talenta')
@section('head')
      ...
      <form action="#" method="post" id="add_barang_form" enctype="multipart/form-data">
        ...
        <div class="modal-body p-4 bg-light">
          ...
          <div class="my-2">
            ...
            <select name="katagori" id="katagori_add" class="form-control">
            <option value="0" selected="selected">Tanpa Katagori</option>
      ...
      <div class="col-lg-12">
        <div class="card shadow" style="width: 80rem;">
          <div class="card-header d-flex justify-content-between align-items-center" style="background-color: #3b3663;">
            <h3 class="text-light">Majemen Barang</h3>
            ...
            <button class="btn btn-light" data-bs-toggle="modal" data-bs-target="#addBarangModal"><i
                class="bi-plus-circle me-2"></i>Add New Barang</button>
          </div>
  ...
  <script>  
    ...
    $(function() {
      ...
      function fetchAllBarangs() {
        $.ajax({
          url: '{{ route('admin.barang.fetchAll') }}',
          method: 'get',
          success: function(response) {
            ...
            $("table").DataTable({
              ...
              buttons: [ 
                { "text":'<i class="fa-solid fa-barcode mr-2"></i>Barcode',"className": 'btn btn-sm', "action": function (){window.location.href='{{url(route('admin.barang.barcode',['type'=> 'semua']))}}'}},

...
<body class="bg-white d-flex align-items-center justify-content-center">
        <div class="row m-3 p-3" style="width: 1000px;">
            <div class="col-12 mb-3">
                <h5>Nota Pengembalian</h5>
                <p>{{$kontak->alamat}} <br>
                {{$kontak->no_tlp}}</p>
            </div>
            <div class="col-12">
           ...
           <div class="col-12 d-flex align-items-center justify-content-center">
               <table style="width: 1000px;" class="table table-striped table-sm text-center " >
                   <thead>
                     <tr>
                   ...
                   <tbody>
                       ...
                       @endforeach
                       <tr class="bg-white">
                           <td colspan="13">Jumlah Tagihan</td>
                           <td>Rp. {{$total}}</td>
                       </tr>
                   </tbody>
               </table>

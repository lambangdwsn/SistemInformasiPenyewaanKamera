...
@section('title','Register Pihak Luar')
@section('content')
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Register Umum') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{url(route('register.as',['role' => 'umum']))}}">
                        @csrf
                        <input id="role" type="hidden" name="role" value="Umum">
                        <div class="row mb-3">

    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{url(route('register.as',['role' => 'siswa']))}}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="NIS" type="text" class="form-control @error('NIS') is-invalid @enderror" onkeypress="return isNumberKey(event)" name="NIS" value="{{ old('NIS') }}" required autocomplete="NIS" maxlength="5">
                                @error('NIS')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
